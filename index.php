...
$fullname = $_REQUEST['fullname']; /* variable that you create to store the name of inputs in HTML */
$phonenumber = $_REQUEST['phonenumber']; /* variable that you create to store the name of inputs in HTML */
$email = $_REQUEST['email'];    /* variable that you create to store the name of inputs in HTML */
...
if(isset($_POST['btntest'])){ /* We use 'btntest' as the name of button in html with using if statement when condition is true*/
   ...
   /* you need to create variables of you database */
    ...
    $db = "opinion"; /* when you create a new database in your localhost then you must write the name of it here*/
    ...
    $insert= "insert into visitors values('$fullname','$phonenumber','$email')";
